...
<div id='contentmodule'>
	...
	<form action='change_order.php' method='POST' name='scouting'>
		...
		<?php
			...
			while($row3 = mysqli_fetch_array($result3)) {
				...
				$result2 = mysqli_query($conn2, "SELECT * FROM questions WHERE part_of_game='$attribute'");
				$result4 = mysqli_query($conn2, "SELECT COUNT(*) AS num_questions FROM questions WHERE part_of_game='$attribute'");
